...
export default function Admin() {
  ...
  async function confirmRoleChange() {
    ...
    try {
      setAds((prev) =>
        prev.map((ad) =>
          ad.id === roleTarget.id ? { ...ad, role: newRole } : ad,
        ),
      );
    } catch (err) {
      console.error("ezis a zsidok hibaja, nemsikerult adminna tenni:", err);
    } finally {
      setRoleTarget(null);
    }
  }
                  ...
                  <td>
                    <div className="ad-preview">
                      ...
                      <div className="ad-preview-info">
                        ...
                        <span className="ad-preview-sub">{ad.megjegyzes}</span>
                      </div>
                    </div>
                  </td>
                  <td>
